                ...
                <div className="p-6">
                    <div className={`grid grid-cols-1 ${evaluationData?.position.toString() === 'Goalkeeper' ? 'md:grid-cols-5' : 'md:grid-cols-3'} gap-4 mt-6`}>
                        ...
                        <div className="text-black p-4 border border-gray-300 rounded-md flex flex-col">
                            ...
                            <div className='prose' dangerouslySetInnerHTML={{ __html: evaluationData?.tacticalRemarks || "<p></p>" }} />
                        ...
                        {evaluationData?.position.toString() === 'Goalkeeper' && (
                            <div className="text-black p-4 border border-gray-300 rounded-md flex flex-col">
                                ...
                                <div className='prose' dangerouslySetInnerHTML={{ __html: evaluationData?.distributionRemarks || "<p></p>" }} />
                        ...
                        <div className="text-black p-4 border border-gray-300 rounded-md flex flex-col">
                            ...
                            <div className='prose' dangerouslySetInnerHTML={{ __html: evaluationData?.physicalRemarks || "<p></p>" }} />
                        ...
                        {evaluationData?.position.toString() === 'Goalkeeper' && (
                            <div className="text-black p-4 border border-gray-300 rounded-md flex flex-col">
                                ...
                                <label htmlFor={`remarks-phys`} className="mt-4 text-sm font-medium">Comments:</label>
                                <div className='prose' dangerouslySetInnerHTML={{ __html: evaluationData?.organizationalRemarks || "<p></p>" }} />
                    ...
                    <div className="mt-6 text-black p-4 border border-gray-300 rounded-md flex flex-col">
                        ...
                        <div className='prose' dangerouslySetInnerHTML={{ __html: evaluationData?.finalRemarks || "<p></p>" }} />
                    </div>

                    <div className="mt-6 text-black p-4 border border-gray-300 rounded-md flex flex-col">
                        <label htmlFor="final-remarks" className="text-sm font-medium">Things to Work On:</label>
                        <div className='prose' dangerouslySetInnerHTML={{ __html: evaluationData?.thingsToWork || "<p></p>" }} />
                    </div>
