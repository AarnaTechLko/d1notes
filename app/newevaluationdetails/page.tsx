                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.comm_persistence || 'N/A'}</p>
                            </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.comm_aggression || 'N/A'}</p>
                            </div>
                            <div className="mb-4 relative">
                                <label className="block text-xs font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.exe_scoring || 'N/A'}</p>
                            </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.exe_receiving || 'N/A'}</p>
                            </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.exe_passing || 'N/A'}</p>
                            </div>
                        </div>
                        {/* Decision Making */}
                        <div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.dec_mobility || 'N/A'}</p>
                                        </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.dec_anticipation || 'N/A'}</p>
                                       </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.dec_pressure || 'N/A'}</p>
                                           </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.soc_speedEndurance || 'N/A'}</p>
                                        </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.soc_strength || 'N/A'}</p>
                                       </div>
                            ...
                            <div className="mb-4 relative">
                                ...
                                <p className="text-sm text-gray-800">{formData.soc_explosiveMovements || 'N/A'}</p>
                            </div>
                        </div>
</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-800">{formData.superStrengths || 'N/A'}</p>
                            </div>

                            <div>
                                <label className="block font-semibold text-gray-800 mb-2">Development Areas</label>
                                <p className="text-sm text-gray-800">{formData.developmentAreas || 'N/A'}</p>
                            </div>

                            <div>
                                <label className="block font-semibold text-gray-800 mb-2">IDP Goals</label>
                                <p className="text-sm text-gray-800">{formData.idpGoals || 'N/A'}</p>
                            </div>

                            <div>
                                <label className="block font-semibold text-gray-800 mb-2">Key Skills</label>
                                <p className="text-sm text-gray-800">{formData.keySkills || 'N/A'}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-800">{formData.attacking || 'N/A'}</p>
                            </div>

                            <div>
                                <label className="block font-semibold text-gray-800 mb-2">Defending</label>
                                <p className="text-sm text-gray-800">{formData.defending || 'N/A'}</p>
                            </div>

                            <div>
                                <label className="block font-semibold text-gray-800 mb-2">Transition Defending</label>
                                <p className="text-sm text-gray-800">{formData.transitionDefending || 'N/A'}</p>
                            </div>

                            <div>
                                <label className="block font-semibold text-gray-800 mb-2">Transition Attacking</label>
                                <p className="text-sm text-gray-800">{formData.transitionAttacking || 'N/A'}</p>
                            </div>
                        </div>
                    </div>
