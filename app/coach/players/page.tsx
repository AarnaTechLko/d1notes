...
const handleDelete = async (id:any) => {
  ...
  />)}
    ...
    <button className='bg-red px-4 py-2 rounded bg-green-500 text-white'>
      {coach.status}
        ...
        {bulkUpload && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-4 rounded-lg w-[80%]  overflow-hidden relative">
              <div className="absolute top-0 left-0 right-0 bg-white p-4 flex justify-between items-center border-b">
                <h2 className="text-2xl font-semibold text-gray-800">Bulk Upload Players</h2>
                <button
              ...
              <div className="pt-16 pb-4 overflow-y-auto h-[60vh] text-center">
              <div>
      <input
        type="file"
        accept=".csv"
 ...
 <div className="filespinner m-auto"></div>
</div>
      )}
