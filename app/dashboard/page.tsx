...
<p className="text-justify">Only if you have been added by an organization or single team that is using D1 Notes’ Organizatons’ (white label) capabilities, you can view that organization’s and team’s internal / private information by <a href="/yourteams" target="_blank" className="text-blue-600 hover:text-blue-800 ">clicking here</a> or on Your Teams in the menu. From here, you can navigate through your team(s)… in order to request an individual game film evaluation from a coach of the organization's team that added you, view the roster and click on a coach’s profile. Only by going through Your Teams will you automatically not be charged any rate as your team's organization has already paid for them.</p>
<p></p>
