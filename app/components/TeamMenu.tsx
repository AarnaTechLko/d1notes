...
<li className="pt-[8px] border-b-1 md:border-b-0">
      ...
      <li className="pt-[8px]">
        <Link href="/teampanel/dashboard" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={closeMenu}>
  ...
  {dropdownOpen && (
    <div className="absolute  left-1/4 md:left-0 mt-2 w-48 z-50  bg-white shadow-lg rounded-md" ref={dropdownMenuRef}>
      <ul>
        <li className="pt-[8px]">
          <Link
            href="/teampanel/profile"
            className={`${isActiveLink("/teampanel/profile")} hover:text-black-300 block w-full text-left px-4 py-2 text-black hover:bg-blue-300`}
        ...
        <li className="pt-[8px]">
          <Link
            href="/teampanel/changepassword"
            className={`${isActiveLink("/teampanel/changepassword")} hover:text-black-300 block w-full text-left px-4 py-2 text-black hover:bg-blue-300`}
            onClick={() => { handleOptionClick(); }}
          >
            Change Password
          </Link>
