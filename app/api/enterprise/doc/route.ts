...
export async function POST(req: NextRequest) {
  ...
  const emailResult = await sendEmail({
    ...
    html: `<p>Dear ${body.name}! You have been added as a Sub Administrator by ${enterproseQuery[0].organizationName}. </p><p>Please login here https://d1notesupdated-five.vercel.app.</p><p>Here are your login details as Organization:</p><p>Email: ${body.email}</p><p>Password: ${password}</p><p>Please change your password upon login</p><br><p>Regards,
